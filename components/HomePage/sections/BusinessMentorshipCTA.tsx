export default function BusinessMentorshipCTA() {
  return (
    <section className="w-full px-4 py-16 relative overflow-hidden bg-gradient-to-b from-secondary/0 to-secondary/10 p-12 md:p-16 lg:p-20">
      {/* Círculos decorativos animados - agora na esquerda */}
      <div className="absolute left-0 top-0 h-full w-1/2 opacity-40">
        <div className="absolute left-[-20%] animate-pulse top-1/2 -translate-y-1/2 h-[150%] aspect-square rounded-full bg-blue-400/30" style={{ animationDuration: '4s' }}></div>
        <div className="absolute left-[-15%] animate-pulse top-1/2 -translate-y-1/2 h-[130%] aspect-square rounded-full bg-purple-400/30" style={{ animationDuration: '3s' }}></div>
        <div className="absolute left-[-10%] animate-pulse top-1/2 -translate-y-1/2 h-[110%] aspect-square rounded-full bg-indigo-400/30" style={{ animationDuration: '2.5s' }}></div>
        <div className="absolute left-[-5%] animate-pulse top-1/2 -translate-y-1/2 h-[80%] aspect-square rounded-full bg-white/20" style={{ animationDuration: '2s' }}></div>
      </div>
